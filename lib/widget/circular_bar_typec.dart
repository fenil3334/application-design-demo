...
class _CircularProgressc extends State<CircularProgressc> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    //percentage * 3.6
    controller = new AnimationController(vsync: this, duration: const Duration(milliseconds: 10000))..forward();
...
class CircularCanvas extends CustomPainter{
  ...
  CircularCanvas({required this.progress, this.backgroundColor = Colors.grey, this.color = Colors.blue});
  @override
